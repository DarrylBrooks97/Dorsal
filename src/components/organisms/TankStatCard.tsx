  ...
  return (
    <MotionStack textAlign="left" spacing={3} shouldWrapChildren>
      <Grid templateColumns="repeat(3, 1fr)">
        <GridItem>
          <Stack textAlign="center" align="center" boxSize="full" rounded="12px">
            <FaWater color="white" />
        ...
        <GridItem>
          <Stack boxSize="full" rounded="12px " textAlign="center" align="center">
            ...
            <GridItem>
              <Stack>
                ...
                <Progress
                  ...
                  rounded="15px"
                  colorScheme={
                    (data.tank.pH as any) < 8.4 && (data.tank.pH as any) > 6.2 ? "green" : "red"
                  }
            ...
            <GridItem>
              <Stack>
                ...
                <Progress
                  size="md"
                  rounded="15px"
                  colorScheme={(data.tank.ammonia as any) < 0.25 ? "green" : "red"}
                  value={((data.tank.ammonia as any) / 6) * 100}
                  isIndeterminate={editing}
                />
              </Stack>
            </GridItem>
            <GridItem>
              <Stack>
                ...
                <Progress
                  size="md"
                  rounded="15px"
                  colorScheme={(data.tank.nirate as any) < 20 ? "green" : "red"}
                  value={((data.tank.nirate as any) / 300) * 100}
                  isIndeterminate={editing}
                />
              </Stack>
            </GridItem>
            <GridItem>
              <Stack>
                ...
                <Progress
                  size="md"
                  rounded="15px"
                  colorScheme={(data.tank.nirite as any) < 0.5 ? "green" : "red"}
                  value={((data.tank.nirite as any) / 100) * 100}
                  isIndeterminate={editing}
                />
              </Stack>
            </GridItem>
            <GridItem>
              <Stack>
                ...
                <Progress
                  ...
                  rounded="15px"
                  colorScheme={
                    (data.tank.hardness as any) < 150 && (data.tank.hardness as any) > 25
                      ? "green"
                      : "red"
                  }
                  value={((data.tank.hardness as any) / 400) * 100}
                  isIndeterminate={editing}
                />
              </Stack>
            </GridItem>
            <GridItem>
              <Stack>
                ...
                <Progress
                  size="md"
                  rounded="15px"
                  colorScheme={(data.tank.chlorine as any) < 0.5 ? "green" : "red"}
                  value={((data.tank.chlorine as any) / 20) * 100}
                  isIndeterminate={editing}
                />
              </Stack>
            </GridItem>
            <GridItem>
              <Stack>
                ...
                <Progress
                  ...
                  rounded="15px"
                  colorScheme={
                    (data.tank.alkalinity as any) < 300 && (data.tank.alkalinity as any) > 120
                      ? "green"
                      : "red"
                  }
                  value={((data.tank.alkalinity as any) / 400) * 100}
                  isIndeterminate={editing}
                />
              </Stack>
            </GridItem>
      ...
      <Box bg="rgba(255,255,255,0.4)" rounded="15px" w="calc(100vw - 3rem)" mb="3">
