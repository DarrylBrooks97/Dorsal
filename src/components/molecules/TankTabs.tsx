import { Box, BoxProps, Center, HStack, Stack, Text } from "@chakra-ui/react"
import { TankTabOptions } from "@constants"
import { Tank } from "@prisma/client"
import { motion } from "framer-motion"
import { FishList, PlantList, TankRemindersCard, TankStatCard } from "src/components/organisms"
import type { FetchedTankData } from "src/utils/index"
...
export function TankTabs({
  ...
  return (
    <Stack spacing={3}>
      <HStack p="3" h="31px" w="full" pos="relative" spacing={3} shouldWrapChildren>
